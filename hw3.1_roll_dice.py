...
## 전역 변수 선언 부분 ##
dice1, dice2, dice3, dice4, diec5, dice6, = [0] * 6
throwcount, consecutivecount = 0, 0
...
if __name__ == "__main__" :
    ...
    print('6개가 동일한 숫자가 나올 떄까지 주사위를 던진 횟수 ->', throwcount)
    print('6개가 동일한 숫자가 나올 때까지, 1~6의 연속번호가 나온 횟수 ->', consecutivecount)
